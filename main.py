...
ap.add_argument("--encoder_model", type=str, help="resnet|inception|vgg|alexnet|squeezenet",
                choices=["resnet", "inception", "vgg", "alexnet", "squeezenet"], default="resnet")
...
ap.add_argument("--embed_path", default="./embeddings/wiki_extvec.gz",
                help="path to embeddings file")
ap.add_argument("--model_path", default="last",
...
if args.mode == "train":
    ...
    if os.path.isfile('./data/processed.pkl.gz'):
        ...
        data.build_vocab()
        data.load_embeddings('./embeddings/wiki_extvec.gz')

    data.resize_images('./data/resized')
    data.pad_data()
